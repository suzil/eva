...
echo ""
echo "Next steps:"
echo "  1. Start Eva: make dev"
echo "  2. Open the UI (http://localhost:5173) → Settings"
echo "  3. Add your Linear API key as a credential (system: linear)"
echo "  4. Open 'Weekly Project Summarizer' → click the 'Linear' connector node"
echo "  5. Select the Linear credential and click Save"
echo "  6. Click Run to execute (or wait for Monday 9:00 AM cron)"
echo ""
echo "To run without a Linear credential (no tool calls — agent uses only team context):"
echo "  Skip steps 2–5 above; the connector degrades gracefully."
