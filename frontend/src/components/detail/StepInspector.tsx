...
function PayloadSection({
  ...
  if (value === null || value === undefined) {
    return (
      <div>
        ...
        <p className="text-[11px] text-gray-600 italic">—</p>
      </div>
    )
  }
    ...
    if (text) {
      return (
        <div>
          ...
          <p className="whitespace-pre-wrap break-words text-[12px] leading-relaxed text-gray-200">
            {text}
          </p>
        </div>
      )
    ...
    if (text) {
      return (
        <div>
          ...
          <p className="whitespace-pre-wrap break-words text-[11px] leading-relaxed text-gray-300">
            {text}
          </p>
        </div>
      )
  ...
  return (
    <div>
      ...
      <pre className="overflow-x-auto whitespace-pre-wrap break-words rounded bg-gray-900 p-2 font-mono text-[10px] leading-relaxed text-gray-400">
...
function NoStepPlaceholder({ hasRun }: { hasRun: boolean }) {
  return (
    <div className="flex flex-1 items-center justify-center p-6">
      <p className="text-center text-[11px] text-gray-600 italic">
        {hasRun
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <div className="flex shrink-0 items-center gap-2 border-b border-gray-800 px-3 py-2">
        ...
        <span className="shrink-0 text-[10px] text-gray-600 capitalize">{typeKey}</span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="space-y-4 p-3">
            ...
            {/* Error */}
            {step.error && (
              <div className="rounded border border-red-900/60 bg-red-950/40 p-2">
                <p className="mb-1 flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wider text-red-500">
                  <AlertCircle size={11} />
                  Error
                </p>
